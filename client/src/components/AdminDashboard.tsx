...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const openWhatsAppChat = (lead: Lead) => {
    ...
    const greeting = encodeURIComponent(
      `Hi ${lead.full_name}, greetings from the ${settings.company_name} team at booth ${settings.booth_id} (${settings.kiosk_venue || 'Jakarta Convention Center'}). Thank you for visiting and signing our guest book!`
    );
          ...
          <div style={{ backgroundColor: '#ffffff', borderRadius: '14px', border: '1px solid #e6e0cd', overflow: 'hidden' }}>
            ...
            >
              ...
              >
                ...
                <option value="mobile_qr">Mobile QR</option>
              </select>
            </div>
